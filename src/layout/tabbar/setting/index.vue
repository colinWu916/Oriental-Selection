<template>
  ...
  <el-popover placement="bottom" title="主题设置" :width="300" :visible="popoverVisible">
    <!-- 表单元素 -->
    <el-form>
    ...
    <template #reference>
      <el-button size="small" icon="Setting" circle @click="popoverVisible = !popoverVisible"></el-button>
    </template>
  </el-popover>
