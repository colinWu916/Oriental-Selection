...
let allData = ref<any>([
  {
    ...
    spuName: 'OPPO',
    description:
      'OPPO（OPPO广东移动通信有限公司）是一家全球领先的智能终端制造商，致力于提供创新的科技产品。',
  },
  {
    index: 2,
    spuName: 'vivo',
    description:
      'vivo 是一家专注于智能手机及其相关产品的公司，以高品质的拍照功能和时尚设计而著称。',
  },
  {
    index: 3,
    spuName: '华为',
    description:
      '华为技术有限公司是一家全球领先的通信技术和智能手机制造商，以高端设备和网络解决方案而闻名。',
  },
  {
    index: 4,
    spuName: '小米',
    description:
      '小米科技有限公司是一家中国电子公司，主要生产智能手机、智能硬件及IoT产品，以高性价比而著称。',
  },
  {
    index: 5,
    spuName: '三星',
  ...
  },
  {
    ...
    spuName: '苹果',
    description:
      '苹果公司是一家美国跨国科技公司，设计并销售消费电子、计算机软件及在线服务，iPhone系列产品享誉全球。',
  },
  {
    index: 7,
    spuName: '诺基亚',
  ...
  },
  {
    ...
    spuName: '中兴',
    description:
      '中兴通讯是一家中国领先的综合通信解决方案提供商，涉及移动终端、网络设备等多个领域。',
  },
  {
    index: 13,
    spuName: 'HTC',
...
const getHasSpu = async (pager = 1) => {
  ...
  // }
  pageNo.value = pager
  records.value = allData.value.slice(
